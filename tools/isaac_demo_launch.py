...
TARGET = STORAGE / 'isaac61_qualification'
STACKS = {
    'isaac61': {
        'lab': TARGET / 'IsaacLab', 'environment': TARGET / 'env',
        'commit': 'ae37b028ea415c91ea2bc32609efcd759ed2b974',
        'pyproject': '2780d507882950e64ca8f972fcad4c19e74b9681af1d830e0b34fa09e79e116b',
        'lock': '98570361a2f86abcfdebfda35f853da0945a8ccbe422f51d5fffaf1936d478a4',
        'packages': {'isaacsim': '6.1.0.0', 'isaaclab': '17.0.2',
                     'isaaclab-teleop': '0.9.0', 'isaacteleop': '1.4.98rc1'},
...
def user_environment(stack: dict, name: str, *, state_root: Path | None = None) -> tuple[dict, Path]:
    ...
    proposed = state_root or home / '.cache/vla' / f'robosyn-{name}'
