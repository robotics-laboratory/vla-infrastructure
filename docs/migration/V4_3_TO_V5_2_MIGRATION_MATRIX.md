...
| Isaac Teleop pin | 1.3.131 | old implementation record, `pyproject.toml`, `uv.lock` | `implementation.isaac_teleop` | B | PRESERVE_AND_REFORMAT | Package pin survives; physical Quest acceptance does not. |
