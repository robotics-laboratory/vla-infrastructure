    ...
    def begin_step(log):
        ...
        if first_step:
            ...
            try:
                ...
                XRSettings.get_singleton().set_setting('profile/persistent/render/resolutionMultiplier',{'E08':.8,'E06':.6,'LIVE-MIN60-NONTILED':.4}.get(candidate,1.0))
            ...
            elif candidate in ('F-minimal','LIVE-MIN60-NONTILED'):
